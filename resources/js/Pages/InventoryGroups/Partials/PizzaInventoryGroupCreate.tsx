...
export default function PizzaInventoryGroupCreate({
}: {
}) {
    const { data, setData, post, processing, errors } = useForm<{
        ...
        type: "pizza",
        date: "",
        big_pizza_remaining_quantity: 0,
        small_pizza_remaining_quantity: 0,
        big_pizza_made_quantity: 0,
        small_pizza_made_quantity: 0,
        big_pizza_useful_quantity: 0,
        small_pizza_useful_quantity: 0,
        big_pizza_sold_quantity: 0,
        small_pizza_sold_quantity: 0,
    });
