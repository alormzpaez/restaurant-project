...
export default function KitchenInventoryGroupCreate({
    // inventoryGroup,
}: {
    ...
    const { data, setData, post, processing, errors } = useForm<{
        ...
        type: "kitchen",
        date: "",
        hamburger_sold_quantity: 0,
        baguette_sold_quantity: 0,
        pasta_sold_quantity: 0,
        salad_sold_quantity: 0,
        quesoFundido_sold_quantity: 0,
        alambre_sold_quantity: 0,
        corte_sold_quantity: 0,
        mollete_sold_quantity: 0,
        arrachera_remaining_quantity: 0,
        arrachera_made_quantity: 0,
        arrachera_useful_quantity: 0,
        arrachera_sold_quantity: 0,
        pollo_remaining_quantity: 0,
        pollo_made_quantity: 0,
        pollo_useful_quantity: 0,
        pollo_sold_quantity: 0,
        chistorra_remaining_quantity: 0,
        chistorra_made_quantity: 0,
        chistorra_useful_quantity: 0,
        chistorra_sold_quantity: 0,
        panHams_remaining_quantity: 0,
        panHams_made_quantity: 0,
        panHams_useful_quantity: 0,
        panHams_sold_quantity: 0,
        panBags_remaining_quantity: 0,
        panBags_made_quantity: 0,
        panBags_useful_quantity: 0,
        panBags_sold_quantity: 0,
        papas_remaining_quantity: 0,
        papas_made_quantity: 0,
        papas_useful_quantity: 0,
        papas_sold_quantity: 0,
        chuleta_remaining_quantity: 0,
        chuleta_made_quantity: 0,
        chuleta_useful_quantity: 0,
        chuleta_sold_quantity: 0,
        molida_remaining_quantity: 0,
        molida_made_quantity: 0,
        molida_useful_quantity: 0,
        molida_sold_quantity: 0,
        asada_remaining_quantity: 0,
        asada_made_quantity: 0,
        asada_useful_quantity: 0,
        asada_sold_quantity: 0,
        pastor_remaining_quantity: 0,
        pastor_made_quantity: 0,
        pastor_useful_quantity: 0,
        pastor_sold_quantity: 0,
        fettuccine_remaining_quantity: 0,
        fettuccine_made_quantity: 0,
        fettuccine_useful_quantity: 0,
        fettuccine_sold_quantity: 0,
        carneHamb_remaining_quantity: 0,
        carneHamb_made_quantity: 0,
        carneHamb_useful_quantity: 0,
        carneHamb_sold_quantity: 0,
    });

    const submit = () => {
        // console.log("Data: ", data)
        post(route('inventory-groups.store'), {
